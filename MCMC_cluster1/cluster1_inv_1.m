...
cfg.workPath   = '/Users/kyuninkim/Downloads/GS_MCMC_code1/MCMC_cluster1';
cfg.datapath   = '/Users/kyuninkim/Downloads/GS_MCMC_code1/Data_file';
cfg.tarFile    = 'GreatSitkin_May25_2021.707912.tar.mseed';
cfg.mseedFile  = 'GreatSitkin_May25_2021.707912/GSSP.AV.mseed';
...
cfg.LPstart = 3873537/50 - 1;
cfg.LPend   = 3874237/50 + 15;
...
cfg.saveEvery    = 200000;       % save .mat checkpoint
cfg.plotEvery    = 200000;       % diagnostics plots
...
stepsize2=0.003;
stepsize=0.003*[1.2*400,100,1*35,1*70,0.5*3,0.4*2.5,1.2,1*200,1.1*100];
