...
% --- I/O
cfg.libPath1   = '/Users/kyuninkim/Downloads/Lib';
cfg.workPath   = '/Users/kyuninkim/Downloads/GS_MCMC_code1';
...
cfg.saveEvery    = 20000;       % save .mat checkpoint
cfg.plotEvery    = 20000;       % diagnostics plots
...
stepsize2=0.003;
stepsize=0.003*[1.2*400,200,1*35,1*70,0.5*3,0.4*2.5,1.6,1*200,0.3*100];
...
if ~isfield(cand.state,'sigma_k_log') || isempty(cand.state.sigma_k_log)
    ...
    if mod(k, cfg.plotEvery) == 0 || any(k == cfg.plotAlsoAt)
        ...
        do_diagnostics(k, cfg, chain, cur, MAP, LP, LPspec, idxAmp, idxPh);
    end
